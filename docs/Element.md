...
Pour s'inscrire il suffit de se rendre sur l'[application web](https://app.element.io/) et de renseigner un .
...
- Répondre
- Modifier le message (ce bouton n'apparait que pour les messages dont on est l'auteur)
- Autres options
